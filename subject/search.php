    ...
    <tr valign="top"><!-- row 3 --> 
      <td bgcolor="ffffcc"> 
        <table width="95%" border="0" cellpadding="3" cellspacing="0" align="center">
          <tr> 
            <td colspan="3"><b><font color="#330099" face="Arial, Helvetica, sans-serif">Please 
              choose one category to search for more experiment details. </font></b> 
          ...
          <tr> 
            <td colspan="2" height="52"> 
              <p class="normal"> 
                <input type="radio" name="ck1" value="OtherExperimenters">
                Other Experimenters:<br>
                <input type="text" name="otherexperimenters">
              </p>
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="3" height="14"> 
              <div align="right"> 
                <hr noshade size="1" width="98%">
                <a href="javascript:history.back(1)"><img src="images/but_back.gif" width="48" height="23" border="0"></a></div>
            </td>
          </tr>
        </table>
      </td>
