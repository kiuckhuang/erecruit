...
<html>
<head>
<title><? echo "Sign Up Policy"; ?></title>
                ...
                <tr valign="top"><!-- row 3 --> 
                  <td bgcolor="ffffcc">
                    ...
                    <table width="95%" border="0" cellpadding="3" cellspacing="0" align="center">
                      <tr>
                        <td class="normal"><b><font color="#FF0000" size="+1" face="Arial">Sign Up Policy</font></b> 
                          <hr noshade size="1" width="98%">
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="normal"><font  face="Arial">Subjects will be blocked from accessing e-Recruit for <font color="#FF0000" size="+1" face="Arial"><? echo BLOCK_PERIOD; ?></font> days if they<br>
                          -have not shown up in experiments that they have signed up for more than <font color="#FF0000" size="+1" face="Arial"><? echo NO_SHOW_BLOCK_COUNT; ?></font> times<br>
                          -have cancelled signups within <font color="#FF0000" size="+1" face="Arial"><? echo CANCEL_B4_HOUR; ?></font> hours before the session start times for more than <font color="#FF0000" size="+1" face="Arial"><? echo CANCEL_BLOCK_COUNT; ?></font> times.<br>
                          </font></p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                      ...
                      <tr>
                        <td>
                          <div align="right">
                            <hr noshade size="1" width="98%">
                               <a href="javascript:history.back(1)"><img src="images/but_back.gif"  border="0"></a></div>
                        </td>
                      </tr>
                    </table>
                  </td>
