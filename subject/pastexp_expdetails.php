...
function changePage(obj) {
    ...
    parent.location = obj.redirect.options[i].value;
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
 		<?
 		$where = "index.php||Log In->pastexp.php||Past Experiments->";
...
<!--<input type="hidden" name="postcourse" value="<? echo $postcourse;?>">-->
                ...
                if($belongto == "Belong_to_Course" || (isset($choose_belongto_exptype) && $choose_belongto_exptype == "course_exptype")){
                     ...
                     $result_course = list_all_exp_from($inputcourse,"course",'n',$page,$order);
                     echo $result_course;
                     ...
                     $result_pool = list_all_exp_from($inputpool,"pool",'n',$page,$order);  
                     echo $result_pool;
                }else{
                ...
                <tr><td>
		<?
		list_all_open_exp('n',$page,$order);
		}
		?>
		</td></tr>
