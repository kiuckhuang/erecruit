<html>
<head>
<title><? echo "Prerequisites"; ?></title>
                ...
                <tr valign="top"><!-- row 3 --> 
                  <td bgcolor="ffffcc">
                    ...
                    <table width="95%" border="0" cellpadding="3" cellspacing="0" align="center">
                      <tr>
                        <td class="normal"><b><font color="#FF0000" size="+1" face="Arial">Prerequisites</font></b> 
                          <hr noshade size="1" width="98%">
                        </td>
                      </tr>
                      <tr>
                                             <td>
                          <p class="normal"><font  face="Arial">
                          You are experienced to an earlier session if the respective experimenters have informed the e-Recruit administrator that 
                          you are experienced to their sessions. <br>
                          </font></p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
