		...
		position("$where"); ?>
              ...
              <hr noshade align="center" width="98%" size="1">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr> 
                    <td width="44%" class="normal"> First Name(s) (e.g. Tai Man)<span class="noteindicator">*</span> 
                      : </td>
                  ...
                  <tr> 
                    <td width="44%" class="normal" bgcolor="ffffcc"> Last Name 
                      (e.g. Chan )<span class="noteindicator">*</span> :</td>
                  ...
                  <tr> 
                    <td width="44%" class="normal"> Email Address (e.g. abc@def.com)<span class="noteindicator">*</span> 
                      : </td>
                    <td width="56%" class="normal"> 
